...
$result = fetchPaginatedRecords($pdo, 'suppliers', 'Name', $search, $limit, $offset);
    ...
    <div class="d-flex">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark flex-column vh-100">
            ...
            <ul class="navbar-nav flex-column">
                ...
                <li class="nav-item">
                    <a href="suppliers.php" class="nav-link active">Manage Suppliers</a>
                </li>
                <li class="nav-item">
        ...
        <div class="container-fluid p-4">
            ...
            <!-- Search Form -->
            <form method="GET" class="d-flex mb-4" action="suppliers.php">
                <input type="text" class="form-control me-2" name="search" placeholder="Search by name" value="<?php echo htmlspecialchars($search); ?>">
                ...
                <tbody>
                    <?php foreach ($suppliers as $row): ?>
                        <tr>
                            ...
                            <td>
                                <a href="edit_supplier.php?id=<?php echo $row['SupplierID']; ?>" class="btn btn-warning btn-sm">Edit</a>
                                <a href="delete_supplier.php?id=<?php echo $row['SupplierID']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this supplier?');">Delete</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
            ...
            <!-- Pagination Links -->
            <?php echo generatePaginationLinks($page, $totalPages, 'suppliers.php', $search); ?>
        </div>
    </div>
</body>
</html>